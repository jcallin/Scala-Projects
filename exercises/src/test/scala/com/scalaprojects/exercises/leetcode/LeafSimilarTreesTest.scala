...
class LeafSimilarTreesTest extends ScalaProjectsSpec {
  it("tells whether 2 trees are leaf similar") {
    ...
    val t2 =
      BinaryTree.fromArray(
        Array(3, 5, 1, 6, 7, 4, 2, null, null, null, null, null, null, 9, 8)
      )
  ...
  it("tells whether 2 trees are not leaf similar") {
    val t1 =
      BinaryTree.fromArray(Array(18, 35, 22, null, 103, 43, 101, 58, null, 97))
    val t2 =
      BinaryTree.fromArray(Array(94, 102, 17, 122, null, null, 54, 58, 101, 97))
